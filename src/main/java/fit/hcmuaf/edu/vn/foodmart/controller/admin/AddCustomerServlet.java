    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("add".equals(action)) {
            ...
            if (existingUser != null) {
                ...
                // Kiểm tra nếu vai trò thay đổi từ Admin sang vai trò khác
                if (oldRole.equals("Admin") && !existingUser.getRole().equals("Admin")) {
                    // Cập nhật vai trò vào cơ sở dữ liệu trước khi đăng xuất
                    boolean isUpdated = userDao.updateUser(existingUser);
                    String message = isUpdated ? "Cập nhật vai trò thành " + existingUser.getRole() + " thành công. Đăng xuất ngay." : "Lỗi: Không thể cập nhật vai trò.";
                    ...
                    // Nếu không phải là thay đổi từ Admin sang User, thực hiện cập nhật bình thường
                    boolean isUpdated = userDao.updateUser(existingUser);
