        ...
        <div class="section active">
            ...
            <div class="cards">
                <div class="card-single">
                    ...
                    %>
                    <div class="box">
                        <h2 id="amount-user"><%= userCount %></h2>
                        <div class="on-box">
                ...
                <div class="card-single">
                    <div class="box">
                        <div class="on-box">
                            ...
                            <h2 id="amount-product"><%= productCount %></h2>
                            <h3>Sản phẩm</h3>
                ...
                <div class="list" data-id="<%= product.getID() %>"
                    ...
                    <div class="list-left">
                        ...
                        <div class="list-info">
                            ...
                            <span class="list-category" data-category-id="<%= product.getCategoryID() %>"><%= product.getCategory().getCategoryName() %></span>
                    ...
                    <div class="list-right">
                        ...
                        <div class="list-control">
                            <div class="list-tool">
                                ...
                                <button class="btn-delete" type="button" data-type="product" data-id="<%= product.getID() %>">
            ...
            <div class="order-statistical" id="order-statistical">
                <div class="order-statistical-item">
                    ...
                    <div class="order-statistical-item-content">
                        ...
                        <h4 class="order-statistical-item-content-h" id="quantity-product"><%= orderCount1 %></h4>
                    </div>
                ...
                <div class="order-statistical-item">
                    ...
                    <div class="order-statistical-item-content">
                        ...
                        <h4 class="order-statistical-item-content-h" id="quantity-order"><%= orderCount2 %></h4>
                    </div>
                    <div class="order-statistical-item-icon">
                ...
                <div class="order-statistical-item">
                    <div class="order-statistical-item-content">
                        ...
                        <h4 class="order-statistical-item-content-h" id="quantity-sale"><fmt:formatNumber value="<%= sumRevenue %>" type="number" pattern="#,###" />&nbsp;₫</h4>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="prod-img-title">
                                <img class="prd-img-tbl" src="<%= product.getImageURL() %>" alt="<%= product.getProductName() %>">
                                <p><%= product.getProductName() %></p>
                            </div>
                        </td>
                        <td><%= product.getStockQuantity() %></td>
                        <td><%= product.getPrice() %></td>
                        <td><button class="btn-detail product-order-detail" data-id="<%= product.getID() %>">
                    ...
                    <form id="product-form" method="post" action="${pageContext.request.contextPath}/addProduct" enctype="multipart/form-data">
                        ...
                        <div class="modal-content-right">
                            ...
                            <div class="form-group">
                                ...
                                <input id="phan-tram-giam" name="DiscountPercentage" type="number" step="0.01" placeholder="Nhập %"
                                       class="form-control" required>
                                <span class="form-message"></span>
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-container3">
                ...
                <div class="modal-detail-footer">
                    ...
                    <div class="footer-right">
                        <button class="footer-btn btn-status" id="order-status" onclick="toggleOrderStatus(this, 1)">Chưa xử lý</button>
                    </div>
                </div>
            </div>
        </div>
